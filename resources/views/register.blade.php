...
<nav class="navbar main-nav fixed-top navbar-expand-lg p-3 bg-light" style="overflow-x: hidden;">
  <div class="container-fluid">
    <a class="navbar-brand" href="{{route('home')}}"><img src="{{asset('images/recruit.png')}}" style="height: 35px; width: 35px;" alt="logo"><span class="h5  text-dark text-capitalize px-2"><b class="text-dark" style="padding-top: 5px;">StudPort | </b> <b class="text-warning">Sign Up</b></span></a>    
  </div>
</nav> 
        ...
        <div class="col-lg-6 col-md-6 col-12 pl-4">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="p-2">
                    ...
                    <small>{{ $errors->first('password_confirm', 'Confirm password') }}</small> 
                </div>
                <div class="d-flex flex-row">
                    <div class="col-lg-6 p-2">
                        <input type="submit" class="form-wizard-next-btn rounded" value="Create Account">
                    </div>
                </div>
                <h6 class="p-2">Got an account? <a href="{{route('login')}}" class="text-danger">Login here</a></h6>
                <div class="d-flex flex-row">
                    <div class="p-2">
                        <input type="checkbox" required="required">
                    </div>
                    <div class="p-2 mt-2">
                    <p><b>By clicking "Create Account" you agree to our Consent Clause for <a href="#">Data Collection</a> and <a href="#">Privacy Policy.</a></b></p>
                    </div>
                </div>
            </div>
        </form>
