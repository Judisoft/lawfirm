...
=            Page Title            =
=================================-->
<section class="video-promo section bg-2">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="content-block">
					<!-- Heading -->
					<h2 style="font-weight: 800;">About {{$institution->institution_name}}</h2>
					<!-- Promotional Speech -->
					<p class="text-light">Click to watch Video </p>
					<!-- Popup Video -->
						  ...
						  <div class="item">
						  	<div class="item-link p-2">
							    <a data-toggle="collapse" data-parent="#gstAccordion" href="#gstAccordion1">
							      <h4 class="text-info"><i class="ti-control-play"></i> Hnd Programmes &nbsp; ({{$hndProgrammes->count()}})</h4>
							    </a>
						  	</div>
						  ...
						  <div class="item">
						  	<div class="item-link p-2">
							    <a data-toggle="collapse" data-parent="#gstAccordion" href="#gstAccordion2">
							      <h4 class="text-info"><i class="ti-control-play"></i> Bachelors Programmes &nbsp; ({{$bachelorsProgrammes->count()}})</h4>
							    </a>
						  	</div>
						  ...
						  <div class="item">
						  	<div class="item-link p-2">
							    <a data-toggle="collapse" data-parent="#gstAccordion" href="#gstAccordion3">
									<h4 class="text-info"><i class="ti-control-play"></i> Masters Programmes &nbsp; ({{$mastersProgrammes->count()}})</h4>
							    </a>
						  	</div>
						  ...
						  <div class="item">
						  	<div class="item-link p-2">
							    <a data-toggle="collapse" data-parent="#gstAccordion" href="#gstAccordion4">
									<h4 class="text-info"><i class="ti-control-play"></i> Phd Programmes &nbsp; ({{$phdProgrammes->count()}})</h4>
							    </a>
						  	</div>
...
<section class="call-to-action-app section bg-blue">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 style="font-weight: 400;">Apply Now </h2>
                <br>
