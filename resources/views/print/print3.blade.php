          ...
          <div class="col-lg-12 col-md-12 col-12 mt-0">
            ...
            <div class="invoice p-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
                        <h3 class="border-line p-3 mt-2 text-uppercase h5">{{$user->institution_3}}</h3>
                    ...
                    <div class="row justify-content-between mx-auto step-container">
                        <div class="col-md-3 col-4">
                            <div class="d-flex flex-row">
                                ...
                                <div class="p-2"><h5 class="text-uppercase bold">{{$user->faculty_3}}</h5></div>
                            </div>
                        ...
                        <div class="col-md-3 col-4">
                            <div class="d-flex flex-row">
                                ...
                                <div class="p-2"><h5 class="text-uppercase bold">{{$user->department_3}}</h5></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-4">
                            <div class="d-flex flex-row">
