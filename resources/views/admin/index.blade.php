    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h4 class="mb-0 font-weight-medium d-none d-lg-flex">DASHBOARD</h4>
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                ...
                @else
                <img class="img-sm rounded-circle" src="{{asset('template/images/faces-clipart/no_avatar.jpg')}}" alt="profile image">
                @endif 
                <span class="font-weight-normal"> {{$user_name}} </span></a>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item pro-upgrade">
              <span class="nav-link">
                <a class="btn btn-block px-0 btn-rounded btn-upgrade" href="#"> <i class="icon-badge mx-2"></i> Upgrade to Pro</a>
              </span>
            </li>
          </ul>
        </nav>
        ...
        <div class="main-panel">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="d-sm-flex align-items-baseline report-summary-header">
                          <h5 class="font-weight-semibold text-uppercase">Report Summary</h5> <span class="ml-auto">Updated Report</span> <button class="btn btn-icons border-0 p-2"><i class="icon-refresh"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="row report-inner-cards-wrapper">
                      <div class=" col-md -6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          <h4>{{$users->count()}}</h4>
                          <span class="report-count"><a href="#">view all</a></span>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">INSTITUTIONS</span>
                          <h4>{{$institutions}}</h4>
                          <span class="report-count"><a href="#">view all</a></span>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <span class="report-title">APPLICATIONS</span>
                          <h4>{{$applications}}</h4>
                          <span class="report-count"><a href="#">view all</a></span>
                        </div>
                  ...
                  <div class="card-body">
                    <div class="row income-expense-summary-chart-text">
                      ...
                      <div class=" col-md-3 col-xl-2">
                        <p class="income-expense-summary-chart-legend"> <span style="border-color: var(--success);"></span> Total Income </p>
                        <h3 class="text-success">00 FCFA</h3>
                      </div>
                      <div class="col-md-3 col-xl-2">
                        <p class="income-expense-summary-chart-legend"> <span style="border-color: var(--danger);"></span> Total Expense </p>
                        <h3 class="text-danger">00 FCFA</h3>
                      </div>
                      ...
                      <table class="table table-hover table-striped">
                        ...
                        <tbody>
                              @foreach($users as $user)
                                  <tr>
                                      <td><a href="{{ URL::route('admin.users.show',Sentinel::getUser()->id) }}">
                                          @if($user->pic)
                                          <img class="img-sm rounded-circle" src="{{$user->pic}}" alt="profile image"> 
                                          @elseif($user->gender == 'm')
                                          <img class="img-sm rounded-circle" src="{{asset('template/images/faces-clipart/pic-1.png')}}" alt="profile image">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © studport.cm 2021</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
